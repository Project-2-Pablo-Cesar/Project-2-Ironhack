...
router.get('/admin-control',hasRole("ADMIN"), (req, res, next) => {
  ...
  router.post("/services/:id/delete", (req, res, next) => {
    const serviceId = req.body.userId;
...
//     const { title,serviceDescription, day, moonth} = req.body;
// console.log(req.body)
//     User.findOneAndUpdate ({'_id': req.params.id}, { $set: { title, serviceDescription, day, month}})
//     //console.log(req.body)
//     .then(() => {
//       res.redirect("/admin/admin-control")
//     })
